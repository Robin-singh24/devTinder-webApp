...
const Connections = () => {
    ...
    if (connections.length === 0) return <h1 className='flex justify-center font-bold text-3xl'>No Connections Found</h1>
    ...
    return (
        <div className='text-center my-10 '>
            ...
            {connections.map((connection) => {
                ...
                return (
                    <div key={_id} className="flex bg-base-100 shadow-sm w-1/2 mx-auto my-6">
                        <div>
                            <img
                                alt="photo"
                                src={photoUrl}
